...
const nameBand = 'AVENIDA LARCO';

const nameSongs = [
	"AMANTE BANDIDO", /*1*/
	"AVENIDA LARCO", /*2*/
	"LA UNIVERSIDAD", /*3*/
	"Y ES QUE SUCEDE ASÍ ", /*4*/
	"CONTESTAME", /*5*/
	"LO PEOR DE TODO", /*6*/
	"SUNA - MAR DE COPAS", /*7*/
	" LAS TORRES", /*8*/
	"AL COLEGIO NO VOY MÁS", /*9*/
	"SUCIO POLICÍA ", /*10*/
	"FRÁGIL", /*11*/
	"DECIR ADIÓS - AMEN", /*12*/
	"DEMOLICIÓN ", /*13*/
	"MUJER NOCHE ", /*14*/
	"MÁS PODER", /*15*/
	"LOS PATOS Y LAS PATAS ", /*16*/
	"AMORES QUE ACABAN", /*17*/
	"LOS GLOBOS DEL CIELO", /*18*/
	"NO PENSÉ QUE ERA AMOR", /*19*/
	"ESA SÍ ES UNA MUJER", /*20*/
]
